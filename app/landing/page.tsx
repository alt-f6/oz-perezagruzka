...
const EXAM_METADATA = {
  oge: {
    ...
    description:
      "Онлайн-школа для подростков 7–9 класса: мини-группы, живой учитель и ИИ-репетитор на связи 24/7. Бесплатный пробный урок перед стартом.",
  },
  ege: {
    title: "Перезагрузка: Подготовка к ЕГЭ с живым учителем и ИИ-репетитором",
    description:
      "Онлайн-школа для старшеклассников 10–11 класса: мини-группы, живой учитель и ИИ-репетитор на связи 24/7. Бесплатный пробный урок перед стартом.",
  },
} as const;
