...
export const REGIONS: Record<RegionSlug, RegionContent> = {
  ...
  nizhnevartovsk: {
    ...
    heroSubcopy:
      "Бесплатный пробный урок, на котором видно текущий уровень ребёнка, мини-группы с живым учителем и ИИ-репетитор на связи 24/7.",
    benchmarks: [
      {
        name: "НВГУ",
        detail:
      ...
      },
      {
        ...
        detail:
          "На пробном уроке показываем, сколько баллов не хватает до цели, и называем конкретные темы, которые их добирают.",
      },
    ],
    scheduleNote:
  ...
  "khanty-mansiysk": {
    ...
    curatorNote: "Куратор центра встречает лично и на пробном уроке помогает выбрать формат подготовки.",
    hasOffice: true,
