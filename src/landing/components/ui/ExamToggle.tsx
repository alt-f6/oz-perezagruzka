...
export default function ExamToggle() {
  ...
  return (
    <div className="flex justify-center border-b border-ink-100 bg-white/85 px-4 py-3 backdrop-blur-xl">
      <div
        role="radiogroup"
        ...
        {OPTIONS.map((option) => {
          ...
          return (
            <button
              ...
              className={`rounded-full px-4 py-2 text-sm font-bold transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 ${
                selected
