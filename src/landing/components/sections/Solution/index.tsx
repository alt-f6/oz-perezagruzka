  ...
  return (
    <Section id="solution" className="bg-transparent scroll-mt-20" paddingOverride="py-12 md:py-20">
      <div className="relative mx-auto max-w-6xl px-6">
        <div className="mt-2 mb-16 overflow-hidden rounded-[32px] border border-brand-200/80 bg-white/90 p-8 md:p-12 shadow-xl shadow-brand-900/5 backdrop-blur-md">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-3xl border border-ink-100 bg-ink-50/70 p-6 md:p-8 transition-all hover:border-ink-200">
              ...
              <p className="mt-3 text-xs leading-relaxed text-ink-500">
                Частный репетитор — сам себе и педагог, и методист, и администратор. Либо это стоит
                намного дороже рынка, либо страдает качество — без методиста, который проверяет
                прогресс не на словах, а в цифрах.
              </p>
            </div>

            <div className="relative rounded-3xl border-2 border-brand-300 bg-brand-50/80 p-6 pt-8 md:p-8 md:pt-10 shadow-xl shadow-brand-900/5">
              ...
              <p className="mt-3 text-xs font-medium leading-relaxed text-brand-700">
                У нас каждого педагога проверяет методист — поэтому весь ресурс педагога уходит на
                главное: личное внимание и точку роста ребёнка, а не на административную текучку.
              </p>
            </div>
          </div>
        </div>
